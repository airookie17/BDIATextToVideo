...
class BDIADDIMSchedulerOutput(BaseOutput):
    """
...
class BDIADDIMScheduler(SchedulerMixin, ConfigMixin):
    """
    ...
    def __init__(
            ...
            gamma: float = 0.5,  # Adding gamma parameter
    ):
    ...
    def step(
    ...
    ) -> Union[BDIADDIMSchedulerOutput, Tuple]:
        """
        ...
        return BDIADDIMSchedulerOutput(prev_sample=prev_sample, pred_original_sample=pred_original_sample)
